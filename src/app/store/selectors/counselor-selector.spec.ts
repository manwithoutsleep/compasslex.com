...
describe('counselorSelector', () => {
    ...
    describe('selectCounselorByFirstName', () => {
        const expectedCounselorList = [counselorBuilder(), counselorBuilder(), counselorBuilder()];
        ...
        it('should return the specified counselor', (done) => {
            ...
            mockReduxStore
                .select(selectCounselorByFirstName(expectedCounselor.firstname))
                .subscribe((counselor) => {
        ...
        it('should return undefined when the specified counselor is not found', (done) => {
            ...
            mockReduxStore
                .select(selectCounselorByFirstName('incorrect first name'))
                .subscribe((counselor) => {
        ...
        it('should return undefined when the list is empty', (done) => {
            ...
            mockReduxStore
                .select(selectCounselorByFirstName('irrelevant first name'))
                .subscribe((counselor) => {
                    expect(counselor).toBeUndefined();
                    done();
                });
    ...
    describe('selectCounselorStateError', () => {
        it('should return undefined when the list is loaded and the counselor is found', (done) => {
            ...
            mockReduxStore
                .select(selectCounselorStateError(expectedCounselor.firstname))
        ...
        it('should return REQUESTED_COUNSELOR_NOT_FOUND when the list is loaded and the counselor is found', (done) => {
            ...
            mockReduxStore
                .select(selectCounselorStateError('incorrect first name'))
                .subscribe((errorMessage) => {
                    expect(errorMessage).toEqual(
