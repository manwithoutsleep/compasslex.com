import { newsletterListErrorMessageResolver, NewsletterListStoreStatus } from './newsletter-list-error-message-resolver';
...
describe('newsletterListErrorMessageResolver', () => {
    it('should return the appropriate error message when given NewsletterListStoreStatus.LOADING_NEWSLETTER_LIST', () => {
        const actual = newsletterListErrorMessageResolver(NewsletterListStoreStatus.LOADING_NEWSLETTER_LIST);
    ...
    it('should return the appropriate error message when given NewsletterListStoreStatus.NO_NEWSLETTER_FOUND', () => {
        const actual = newsletterListErrorMessageResolver(NewsletterListStoreStatus.NO_NEWSLETTERS_RETURNED_FROM_SERVER);
