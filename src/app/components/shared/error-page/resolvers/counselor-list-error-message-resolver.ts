...
export class CounselorListStoreStatus extends StoreStatus {
    ...
    static readonly NO_COUNSELORS_RETURNED_FROM_DATA_STORE = '<CounselorListStoreStatus> NO_COUNSELORS_RETURNED_FROM_SERVER';
    static readonly REQUESTED_COUNSELOR_NOT_FOUND = '<CounselorListStoreStatus> REQUESTED_COUNSELOR_NOT_FOUND';
}
