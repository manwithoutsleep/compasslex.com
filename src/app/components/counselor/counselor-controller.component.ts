...
import { selectCounselorListLoadState, selectCounselorListStateError, selectCounselorByFirstName } from 'src/app/store/selectors/counselor-selector';
import { ActivatedRoute } from '@angular/router';

@Component({
    selector: 'app-counselor-controller',
    template: `<app-counselor
        [counselor]="counselor$ | async">
    </app-counselor>
    <app-error-page
