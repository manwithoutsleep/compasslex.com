...
--
-- Host: localhost:3306
-- Generation Time: Sep 10, 2023 at 02:16 PM
...
INSERT INTO `counselors` (`id`, `email`, `firstname`, `lastname`, `longdescription`, `phone`, `practitionerid`, `shortdescription`, `directoryid`, `sortorder`) VALUES
...
INSERT INTO `credentials` (`id`, `counselorid`, `content`) VALUES
(10, 3, 'M.A. in Marriage & Family Counseling, Asbury Theological Seminary, KY'),
...
(16, 4, 'M.A. in Mental Health Counseling, Asbury Theological Seminary, Wilmore, KY'),
(17, 4, 'B.S. in Medical Technology, Morehead State University, Morehead, KY'),
(18, 4, 'Licensed Professional Clinical Counselor (LPCC)'),
(19, 4, 'Allender Center Training Certificate - Level 1, Seattle, WA'),
(20, 4, 'Acceptance and Commitment Therapy Boot Camp, Philadelphia, PA'),
(27, 5, 'M.A. in Mental Health Counseling, Asbury Theological Seminary, Wilmore, KY'),
(28, 5, 'M.A in Diplomacy and International Commerce, University of Kentucky, Lexington, KY'),
(29, 5, 'B.A in Business Administration, Asbury University, Wilmore, KY'),
(30, 5, 'Licensed Professional Counseling Associate (LPCA)'),
(31, 5, 'Completed Level 1 Training in Gottman Method Couples Therapy'),
(32, 5, 'Story Sage Certified, Allender Center, Seattle, WA'),
(33, 6, 'M.A. Mental Health Counseling, Asbury Theological Seminary, Wilmore, KY'),
(34, 6, 'B.A. History, English, and Creative Writing, Centre College, Danville, KY'),
(35, 6, 'Licensed Professional Counselor Associate (LPCA)'),
(36, 7, 'MA in Clinical Mental Health Counseling, University of the Cumberlands'),
(37, 7, 'BA in Secondary Education, Social Studies, University of Kentucky'),
(38, 8, 'M.A. in Marriage and Family Counseling, Asbury Theological Seminary, Wilmore, KY'),
(40, 8, 'Gottman Couples Therapy certified, level 1'),
(41, 8, 'Certified facilitator, PREPARE/ENRICH premarital and marital counseling'),
(42, 1, 'M.Ed. in Counseling, Stephens College, Columbia, MO'),
(43, 1, 'Ph.D. in Counseling Education and Supervision, University of the Cumberlands, Williamsburg, KY'),
(44, 1, 'B.A. in Theology, Ambassador College, Pasadena, CA'),
(45, 1, 'Externship in Emotionally Focused Couples Therapy, Chicago Center for EFT'),
(46, 1, 'Licensed Professional Clinical Counselor (LPCC)'),
(47, 1, 'Certified Clinical Trauma Professional (CCTP)'),
(48, 3, 'Marriage and Family Therapist, (MFT)');
...
INSERT INTO `insurances` (`id`, `counselorid`, `content`) VALUES
(1, 1, 'Aetna'),
...
(5, 1, 'Passport'),
(6, 1, 'Wellcare'),
(12, 4, 'Aetna Better Health'),
(13, 4, 'Anthem BCBS Medicaid'),
(14, 4, 'Humana Medicaid'),
(15, 4, 'Passport'),
(16, 4, 'Wellcare'),
(22, 5, 'Passport'),
(23, 5, 'Wellcare'),
(24, 5, 'Anthem Medicaid'),
(25, 5, 'Humana Medicaid'),
(26, 5, 'Aetna Better Health'),
(27, 6, 'Passport'),
(28, 6, 'Wellcare'),
(29, 6, 'Anthem Medicaid'),
(30, 6, 'Humana Medicaid'),
(31, 6, 'Aetna Better Health'),
(32, 7, 'Aetna Better Health'),
(33, 7, 'Passport'),
(34, 7, 'Wellcare'),
(35, 7, 'Humana Medicaid'),
(36, 7, 'Anthem Medicaid'),
(37, 7, 'Anthem BlueCross/BlueShield'),
(38, 8, 'Aetna Better Health'),
(39, 8, 'Passport'),
(40, 8, 'Wellcare'),
(41, 8, 'Humana Medicaid'),
(42, 8, 'Anthem Medicaid'),
(43, 8, 'Anthem BlueCross/BlueShield'),
(45, 4, 'Anthem BlueCross/BlueShield'),
(46, 5, 'Anthem BlueCross/BlueShield'),
(47, 6, 'Anthem BlueCross/BlueShield'),
(48, 3, 'Aetna'),
(49, 3, 'Anthem Blue Cross/Blue Shield'),
(50, 3, 'Cigna'),
(51, 3, 'Humana'),
(52, 3, 'Passport'),
(53, 3, 'Wellcare');
...
INSERT INTO `memberships` (`id`, `counselorid`, `content`) VALUES
...
(9, 4, 'American Counseling Association (ACA)'),
(10, 4, 'Kentucky Counseling Association (KCA)'),
(11, 4, 'Christian Association for Psychological Studies (CAPS)'),
(15, 5, 'American Counseling Association (ACA)'),
(16, 5, 'Kentucky Counseling Association (KCA)'),
(17, 5, 'Christian Association for Psychological Studies (CAPS)'),
(18, 6, 'American Counseling Association (ACA)'),
(19, 6, 'Kentucky Counseling Association (KCA)'),
(20, 6, 'Christian Association for Psychological Studies (CAPS)'),
(21, 7, 'Kentucky Counseling Association (KCA)'),
(22, 7, 'American Counseling Association (ACA)'),
(23, 8, 'Kentucky Counseling Association (KCA)'),
(24, 8, 'American Counseling Association (ACA)'),
(25, 8, 'Christian Association for Psychological Studies (CAPS)'),
(26, 8, 'International Association of Marriage and Family Counselors (IAMFC)');
...
INSERT INTO `titles` (`id`, `counselorid`, `content`) VALUES
(1, 1, 'Ph.D, LPCC-S'),
(4, 3, 'M. A., Marriage and Family Therapist'),
(5, 4, 'M.A., LPCC'),
(6, 5, 'M. A., LPCA'),
(7, 6, 'M. A., LPCA'),
(8, 7, 'M. A., LPCA'),
(9, 8, 'M. A., Marriage and Family Therapist Associate');
